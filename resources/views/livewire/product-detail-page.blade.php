            ...
            <div class="flex flex-wrap -mx-4">
                <div class="w-full mb-8 md:w-1/2 md:mb-0"
                    ...
                    <div class="sticky top-0 z-10 overflow-hidden">
                        <div class="relative mb-6 py-4 lg:mb-10 h-96 border flex justify-center">
                            <img x-bind:src="mainImage" alt="{{ $product->name }}"
                                 class="object-contain w-full lg:h-full">
                        </div>
                        <div class="flex-wrap hidden md:flex box-border">

                            @foreach( $product->images as $image)
                                <div
                                    class="w-1/2 p-2 sm:w-1/5 border hover:border hover:border-blue-500 flex justify-center"
                                    x-on:click="mainImage='{{ url('storage', $image ) }}'">
                                    <img src="{{ url('storage', $image ) }}" alt="{{ $product->name }}"
                                         class="object-center lg:h-20 cursor-pointer">
                                </div>
                            @endforeach
                ...
                <div class="w-full px-4 md:w-1/2 ">
                    <div class="lg:pl-20">
                        ...
                        <div class="w-24 mb-8 ">
                            ...
                            <div class="relative flex justify-center flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                                <button wire:click="decreaseQty"
                                    class="w-24 h-full text-gray-600 bg-gray-300 rounded-l outline-none cursor-pointer dark:hover:bg-gray-700 dark:text-gray-400 hover:text-gray-700 dark:bg-gray-900 hover:bg-gray-400">
                                    <span class="m-auto text-2xl font-thin">-</span>
                                </button>
                                <input type="number" readonly wire:model="quantity"
                                       class="flex items-center w-full font-semibold text-center text-gray-700 placeholder-gray-700 bg-gray-300 outline-none dark:text-gray-400 dark:placeholder-gray-400 dark:bg-gray-900 focus:outline-none text-md hover:text-black" >
                                <button wire:click="increaseQty"
                                        class="w-24 h-full text-gray-600 bg-gray-300 rounded-r outline-none cursor-pointer dark:hover:bg-gray-700 dark:text-gray-400 dark:bg-gray-900 hover:text-gray-700 hover:bg-gray-400">
                                    <span class="m-auto text-2xl font-thin">+</span>
                                </button>
                            </div>
                        </div>
