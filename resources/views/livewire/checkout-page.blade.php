                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            ...
                            <div>
                                ...
                                <input wire:model="zip"
                                       class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('zip') border-red-500 @enderror"
                                       id="zip" type="text">
                                </input>
                                @error('zip')
                                <div class="text-red-500 text-sm">{{ $message }}</div>
                            ...
                            <li class="py-3 sm:py-4" wire:key="{{ $item['product_id'] }}">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <img alt="{{ $item['name'] }}" class="w-12 h-12 rounded-b-lg"
